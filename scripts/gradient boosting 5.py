...
# save model
joblib.dump(best_model, "best_gradient_boost_model.pkl")
print("Model saved")
...
plt.title("Actual vs Predicted Monthly Rent - Gradient Boosting", fontsize=14)
#label
...
# Residuals = actual - predicted, used to check error pattern
