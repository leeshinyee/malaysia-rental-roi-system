...
# define model
extratree_regressor = ExtraTreesRegressor(random_state=42)
...
# save model
joblib.dump(best_model, "best_extra_tree_model.pkl")
print("Model saved")
...
plt.title("Actual vs Predicted Monthly Rent - EXtra Tree", fontsize=14)
#label
...
plt.title("Residual Plot - EXtra Tree")
...
plt.ylabel("RMSE")
plt.title("Learning Curve - EXtra Tree")
plt.legend()
plt.grid(True, alpha=0.3)
plt.tight_layout()
...
plt.title("Top 10 Feature Importances - EXtra Tree")
plt.tight_layout()
